<%-- 
    Document   : viewDocLesson
    Created on : Feb 21, 2025, 3:45:08 AM
    Author     : dohie
--%>
...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <!-- Sidebar -->
            <%@include file="${pageContext.request.contextPath}/adminSidebar.jsp" %>
            <!-- End of Sidebar -->
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- Topbar -->
                    <%@include file="${pageContext.request.contextPath}/topBar.jsp" %>
                    <!-- End of Topbar -->
                    ...
                    <div class="container-fluid">
                        ...
                        <span style="color: black">${docs.content}</span>
                        <br />
