<%-- 
    ...
    Created on : Feb 21, 2025, 2:33:22 PM
    Author     : dohie
--%>
        ...
        <div style="overflow-x: hidden">
            ...
            <header class="p-1 pr-2 pl-2 pr-md-5 pl-md-5 d-flex align-items-center justify-content-center" role="banner"
                ...
                <div class="mr-auto d-flex flex-row justify-content-center align-items-center">
                    <a class="text-white d-inline pr-4 btn btn-lg" title="Exit" href="${pageContext.request.contextPath}/course/${course.slug}" >
                ...
                <div class="site-logo d-none d-md-block">
                    <a href="${pageContext.request.contextPath}/home" class="d-block">
                        <img src="${pageContext.request.contextPath}/images/home/logo.png" alt="Image" style="transform: scale(0.9,0.9)" class="img-fluid">
                    </a>
                </div>
            </header>
            <!--Body-->
            <div class="row full" id="main" style="overflow-y: scroll;">
                ...
                <div class="col-md-9 div1 pt-3" 
                    ...
                    <div class="col-md-12 disable_section" id="reviewpart"  <c:if test="${requestScope.review == null}">style="display: none;"</c:if><c:if test="${requestScope.review != null}">style="display: block;"</c:if>>
                            <form action="${pageContext.request.contextPath}/reviewcourse">
                                ...
                                <div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
                                    ...
                                    <div class="row">
                                        ...
                                        <c:if test="${sessionScope.account.id == cr.userId}">
                                            <div class="col-1">
                                                <a href="${pageContext.request.contextPath}/deletereview?id=${cr.id}&slug=${course.slug}"><i class="ti-trash"></i></a>
                                            </div>
                                        </c:if>
                                    </div>
                                </div>
                    ...
                    <div id="lesson_content">
                        <ul class="list-group list-group-light">
                            ...
                            <c:forEach items="${listLesson}" var="l" >
                                <a href="${pageContext.request.contextPath}?id=<%=i%>" 
            ...
            <div class="m-0 d-flex align-items-center nowrap row p-2" 
                ...
                <div class="text-right col-10 col-sm-7">
                    ...
                    <c:if test="${param.id> 1}">
                        <a type="button" class="btn btn-outline-primary mr-2" href="${pageContext.request.contextPath}?id=${param.id - 1}">
                            <i class="fa-solid fa-chevron-left fa-beat-fade"></i>
                            <fmt:message key="button.Previous" /> 
                        </a>
                    </c:if>
                    ...
                    <c:if test="${param.id < listLesson.size()}">
                        <a type="button" class="btn btn-outline-primary ml-2" href="${pageContext.request.contextPath}?id=${param.id + 1}">             
                            <fmt:message key="button.Next" />
                            <i class="fa-solid fa-chevron-right"></i>
                        </a>
                    </c:if>
                    ...
                    <c:if test="${param.id == null}">
                        <a type="button" class="btn btn-outline-primary ml-2" href="${pageContext.request.contextPath}?id=2">             
                            <fmt:message key="button.Next" />
                            <i class="fa-solid fa-chevron-right"></i>
                        </a>
                    </c:if>
