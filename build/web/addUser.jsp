        ...
        <form method="post" action="AddUserServlet">
            ...
            <div class="mb-3">
                ...
                <select name="roleID" class="form-select">
                    ...
                    <option value="4" ${roleID == 4 ? 'selected' : ''}>Sale</option>
                    <option value="4" ${roleID == 5 ? 'selected' : ''}>Marketing</option>
                </select>
            </div>

            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary px-4">Add User</button>
                <a href="UserListServlet" class="btn btn-secondary px-4">Cancel</a>
            </div>
        </form>
    </div>
